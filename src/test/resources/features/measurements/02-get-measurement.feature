Feature: Get a measurement
  ...
  #new
  Scenario: Test precipitation statistics
    Given I have submitted new measurements as follows:
      | timestamp                  | temperature | dewPoint | precipitation |
      | "2015-09-01T16:00:00.000Z" | 27.1        | 16.7     | 1             |
      | "2015-09-01T16:10:00.000Z" | 27.3        | 16.9     | 3             |
      | "2015-09-01T16:20:00.000Z" | 27.5        | 17.1     | 6             |
      | "2015-09-01T16:30:00.000Z" | 27.4        | 17.3     | 8             |
      | "2015-09-01T16:40:00.000Z" | 27.2        | 17.2     | 10            |
      | "2015-09-02T16:00:00.000Z" | 28.1        | 18.3     | 2             |
    When I get stats with parameters:
      ...
      | toDateTime   | 2015-09-02T16:00:00.000Z |
    Then the response has a status code of 200
    And the response body is an array of:
      | metric             | stat      | value |
      | "precipitation"    | "min"     | 1  |
      | "precipitation"    | "max"     | 10  |
      | "precipitation"    | "average" | 5.6  |